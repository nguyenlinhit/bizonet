...
This mechanism has been integrated into Bitcore-Node-bizonet which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/nguyenlinhit/insight-api-bizonet#web-socket-api](https://github.com/nguyenlinhit/insight-api-bizonet#web-socket-api)
* API: [https://github.com/nguyenlinhit/insight-api-bizonet#instantsend-transactions](https://github.com/nguyenlinhit/insight-api-bizonet#instantsend-transactions)
...
By default, the bizonet Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the bizonet Core daemon:
