...
Only requiring some minor changes is bizonet.cpp.
...
Changes to bizonet.cpp
----------------------
bizonet.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
