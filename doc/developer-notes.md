...
bizonet Core is a multithreaded application, and deadlocks or other multithreading bugs
...
However, in open source software such as bizonet Core, where everyone uses
...
pay attention to for reviewers of bizonet Core code.

General bizonet Core
----------------------
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: bizonet Core uses tinyformat, which is type safe. Leave them out to avoid confusion
