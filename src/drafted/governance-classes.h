 ...
 *
 *   // network
 *   CbizonetNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.bizonet.org/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CbizonetNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
public:
    CbizonetNetwork(UniValue objIn)
    {
...
// // can be under: bizonetNetwork
// //   -- signature requirements : Key1(User)
// class CbizonetNetworkVariable : public CGovernanceObject
// {
// private:
