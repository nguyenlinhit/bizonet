...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "bizonetNetwork") type = bizonetNetwork;
    if(strType == "bizonetNetworkVariable") type = bizonetNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == bizonetNetwork) s = "bizonetNetwork";
    if(type == bizonetNetworkVariable) s = "bizonetNetworkVariable";
