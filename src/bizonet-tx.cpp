...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("bizonet Core bizonet-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  bizonet-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded bizonet transaction") + "\n" +
              "  bizonet-tx [options] -create [commands]   " + _("Create hex-encoded bizonet transaction") + "\n" +
              "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded bizonet transaction
