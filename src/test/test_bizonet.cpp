...
#define BOOST_TEST_MODULE bizonet Test Suite

#include "test_bizonet.h"
...
#endif
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_bizonet_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));
