...
2. run bizonetd with -printalert or -sendalert like this:
   /path/to/bizonetd -printalert
...
void ThreadSendAlert(CConnman& connman)
{
    ...
    alert.strComment    = "";
    alert.strStatusBar  = "URGENT: Upgrade required: see https://www.bizonet.org";

    // Set specific client version/versions here. If setSubVer is empty, no filtering on subver is done:
    // alert.setSubVer.insert(std::string("/bizonet Core:0.12.0.58/"));
