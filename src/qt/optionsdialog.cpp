    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("bizonet-light"), QVariant("light"));
    ui->theme->addItem(QString("bizonet-light-hires"), QVariant("light-hires"));
    ui->theme->addItem(QString("bizonet-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("bizonet-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("bizonet-traditional"), QVariant("trad"));
