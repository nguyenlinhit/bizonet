    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("bizonet Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About bizonet Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  bizonet-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the bizonet in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 bizonet, 0.1 bizonet, 1 bizonet and 10 bizonet -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://nguyenlinhit.atlassian.net/wiki/display/DOC/PrivateSend\">https://nguyenlinhit.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("bizonet Core is shutting down...") + "<br /><br />" +
