    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("bizonet Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a bizonet address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and bizonet: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About bizonet Core"), this);
    aboutAction->setStatusTip(tr("Show information about bizonet Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for bizonet Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your bizonet addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified bizonet addresses"));
    ...
    openAction->setStatusTip(tr("Open a bizonet: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the bizonet Core help message to get a list with possible bizonet Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("bizonet Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (clientModel->getNetworkActive()) {
        labelConnectionsIcon->setToolTip(tr("%n active connection(s) to bizonet network", "", count));
    } else {
...
{
    QString strTitle = tr("bizonet Core"); // default title
