...
static int AppInitRPC(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help") || mapArgs.count("-version")) {
        std::string strUsage = _("bizonet Core RPC client version") + " " + FormatFullVersion() + "\n";
        if (!mapArgs.count("-version")) {
            strUsage += "\n" + _("Usage:") + "\n" +
                  "  bizonet-cli [options] <command> [params]  " + _("Send command to bizonet Core") + "\n" +
                  "  bizonet-cli [options] help                " + _("List commands") + "\n" +
                  "  bizonet-cli [options] help <command>      " + _("Get help for a command") + "\n";
